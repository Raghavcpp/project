...
class TwitterBot:
    def __init__(self, username, password,email):
        ...
        sleep(2)
        WebDriverWait(self.driver, 5).until(EC.presence_of_element_located((By.XPATH, '/html/body/div/div/div/div[1]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div/div/div/div[5]/label/div/div[2]/div/input'))).send_keys(email)
        sleep(2)        
        ...
        try:
            ...
            pass
        password_login = self.driver.find_element(by=By.XPATH, value='/html/body/div/div/div/div[1]/div/div/div/div/div/div/div[2]/div[2]/div/div/div[2]/div[2]/div[1]/div/div/div[3]/div/label/div/div[2]/div[1]/input')
        sleep(2)        #password path is causing problem
...
# twitter_bot = TwitterBot("guptaxvivek", "Vivek@9540")
# twitter_bot.update_profile("Vivek Gupta", "I am no one")